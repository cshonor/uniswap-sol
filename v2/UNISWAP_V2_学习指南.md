...
1. [架构概述](#架构概述)
2. [Core（核心合约）](#core核心合约)
   - [CPAMM.sol - Pair 合约](#cpammsol---pair-合约)
   - [CPAMMFactory.sol - Factory 合约](#cpammfactorysol---factory-合约)
3. [Periphery（外围合约）](#periphery外围合约)
   - [CPAMMRouter.sol - Router 合约](#cpammroutersol---router-合约)
4. [合约交互流程](#合约交互流程)
5. [关键概念解析](#关键概念解析)
...
1. **第一步**：理解 CPAMM.sol（Pair 合约）
   - 掌握恒定乘积公式
   - 理解流动性添加/移除机制
   - 理解代币交换逻辑

2. **第二步**：理解 CPAMMFactory.sol
   - 理解 Factory 模式
   - 理解代币排序的重要性
   - 理解交易对管理

3. **第三步**：理解 CPAMMRouter.sol
   - 理解 Router 如何封装核心合约
   - 理解自动比例调整
   - 理解多跳交换
